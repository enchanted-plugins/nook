...
| [failure-modes.md](../enchanter-foundations/packages/core/conduct/failure-modes.md) | 14-code taxonomy for `state/learnings.json` so L5 Gauss Accumulation compounds |

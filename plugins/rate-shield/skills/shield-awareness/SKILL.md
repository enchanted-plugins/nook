...
<override_note>
This shield exists as an explicit override of ../foundations/packages/core/conduct/hooks.md
...
pech-rate-limiter. Override of ../foundations/packages/core/conduct/hooks.md is logged in this
plugin's README.
</output_format>
